/*
 * File: app/view/crm/OferenteCuentaBancariaForm.js
 *
...
Ext.define('cerodatax.view.crm.OferenteCuentaBancariaForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.crmoferentecuentabancariaForm',
    ...
    items: [
        {
            ...
            title: '',
            forceFit: true,
            store: 'crm.OferenteCuentaBancaria',
            columns: [
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'nombre',
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorCuentaBancariaOferente(config);
        if (instanceConfig) {
    ...
    processNomencladorCuentaBancariaOferente: function(config) {
