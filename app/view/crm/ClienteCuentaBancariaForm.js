/*
 * File: app/view/crm/ClienteCuentaBancariaForm.js
 *
...
Ext.define('cerodatax.view.crm.ClienteCuentaBancariaForm', {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorCuentaBancariaCliente(config);
        if (instanceConfig) {
    ...
    processNomencladorCuentaBancariaCliente: function(config) {
