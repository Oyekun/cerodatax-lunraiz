...
Ext.define('cerodatax.view.crm.Cliente', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.crmcliente',

    requires: [
        'cerodatax.view.crm.ClienteViewModel',
        'cerodatax.view.crm.ClienteViewController',
        'Ext.grid.Panel',
