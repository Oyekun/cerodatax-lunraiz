/*
 * File: app/view/administracion/Traza.js
 *
...
Ext.define('cerodatax.view.administracion.Traza', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.administraciontraza',
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'textfield',
                            fieldLabel: 'IP Creado',
                            name: 'created_from_ip'
                        },
                        {
                            xtype: 'textfield',
                            fieldLabel: 'IP Modificado',
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorTipoModulo(config);
        if (instanceConfig) {
    ...
    processNomencladorTipoModulo: function(config) {
