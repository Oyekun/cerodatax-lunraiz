/*
 * File: app/view/seguridad/RolViewController.js
 *
...
Ext.define('cerodatax.view.seguridad.RolViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.seguridadrol',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.roles');
        ...
        // Set title
        formPanel.setTitle('Adicionar  Roles');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Roles');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Desea eliminar el Rol seleccionado?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Roles');
