/*
 * File: app/view/persona/MovimientoEmpleado.js
 *
...
Ext.define('cerodatax.view.persona.MovimientoEmpleado', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.personamovimientoempleado',

    requires: [
        'cerodatax.view.persona.PersonaViewModel4',
        'cerodatax.view.persona.PersonaViewController4',
        'Ext.grid.Panel',
    ...
    controller: 'personamovimientoempleado',
    viewModel: {
        type: 'personamovimientoempleado'
    },
    ...
    dockedItems: [
        {
            ...
            dock: 'bottom',
            displayInfo: true,
            store: 'persona.MovimientoEmpleado'
        }
    ],
