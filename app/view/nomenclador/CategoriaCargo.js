/*
 * File: app/view/nomenclador/CategoriaCargo.js
 *
...
Ext.define('cerodatax.view.nomenclador.CategoriaCargo', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorcategoriacargo',

    requires: [
        'cerodatax.view.nomenclador.CategoriaCargoViewModel',
        'cerodatax.view.nomenclador.CategoriaCargoViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorcategoriacargo',
    viewModel: {
        type: 'nomencladorcategoriacargo'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione la Categorias</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorCategoriaCargo(config);
        if (instanceConfig) {
    ...
    processNomencladorCategoriaCargo: function(config) {
