/*
 * File: app/view/nomenclador/Organismo.js
 *
...
Ext.define('cerodatax.view.nomenclador.Organismo', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladororganismo',
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione un Organismo</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorOrganismo(config);
        if (instanceConfig) {
    ...
    processNomencladorOrganismo: function(config) {
