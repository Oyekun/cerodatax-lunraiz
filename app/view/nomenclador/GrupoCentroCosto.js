/*
 * File: app/view/nomenclador/GrupoCentroCosto.js
 *
...
Ext.define('cerodatax.view.nomenclador.GrupoCentroCosto', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorgrupocentrocosto',

    requires: [
        'cerodatax.view.nomenclador.ClasificacionViewModel3',
        'cerodatax.view.nomenclador.ClasificacionViewController3',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorgrupocentrocosto',
    viewModel: {
        type: 'nomencladorgrupocentrocosto'
    },
    ...
    items: [
        {
            ...
            title: '',
            forceFit: true,
            store: 'nomenclador.GrupoCentroCosto',
            columns: [
                {
                    xtype: 'gridcolumn',
