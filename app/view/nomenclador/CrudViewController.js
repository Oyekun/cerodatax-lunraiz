...
Ext.define('cerodatax.view.nomenclador.CrudViewController', {
    ...
    associate: function(button, e, eOpts) {
        ...
        form.owner.items.items.forEach(function (item) {
            ...
            var resulgrid = [];
            resulgrid = me.searchComponent('gridpanel',vista,resulgrid);
            for(var compgrid in resulgrid)
            {var objgrid = resulgrid[compgrid];
             if(record!==null)
                 objgrid.store.proxy.extraParams.id_asociado =record.data.id;
             else
                 objgrid.store.proxy.extraParams.id_asociado ='';
             delete(objgrid.store.proxy.extraParams.parent_id);// ='';
             objgrid.store.proxy.extraParams.detalles ='edit';
             delete(objgrid.store.proxy.extraParams.combo);// ='combo';
            ...
            {  var result = [];
             ...
             var resulgridtab = [];
             resulgridtab = me.searchComponent('gridpanel',item,resulgridtab);
             for(var compgridtab in resulgridtab)
             {var objgridtab = resulgridtab[compgridtab];
              if(record!==null)
                  objgridtab.store.proxy.extraParams.id_asociado =record.data.id;
              else
                  objgridtab.store.proxy.extraParams.id_asociado ='';
              //objgrid.store.proxy.extraParams.parent_id ='';
              objgridtab.store.proxy.extraParams.detalles ='edit';
              //objgrid.store.proxy.extraParams.combo ='combo';

              objgridtab.store.load();
