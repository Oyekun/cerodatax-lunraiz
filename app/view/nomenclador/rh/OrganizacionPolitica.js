/*
 * File: app/view/nomenclador/rh/OrganizacionPolitica.js
 *
...
Ext.define('cerodatax.view.nomenclador.rh.OrganizacionPolitica', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorrhorganizacionpolitica',

    requires: [
        'cerodatax.view.nomenclador.ProvinciaViewModel12',
        'cerodatax.view.nomenclador.ProvinciaViewController12',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorrhorganizacionpolitica',
    viewModel: {
        type: 'nomencladorrhorganizacionpolitica'
    },
