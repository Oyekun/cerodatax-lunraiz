/*
 * File: app/view/nomenclador/rh/TipoDeduccion.js
 *
...
Ext.define('cerodatax.view.nomenclador.rh.TipoDeduccion', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorrhtipodeduccion',

    requires: [
        'cerodatax.view.nomenclador.ProvinciaViewModel1',
        'cerodatax.view.nomenclador.ProvinciaViewController1',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorrhtipodeduccion',
    viewModel: {
        type: 'nomencladorrhtipodeduccion'
    },
    ...
    items: [
        {
            ...
            title: '',
            forceFit: true,
            store: 'nomenclador.rh.TipoDeduccion',
            columns: [
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'nombre',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            name: 'cuentacontable_id',
                            allowBlank: false,
                            emptyText: 'Seleccione',
                            displayField: 'nombre',
                            queryMode: 'local',
                            store: 'nomenclador.contabilidad.CuentaContable',
                            valueField: 'id'
                        }
                    ],
                    dockedItems: [
