/*
 * File: app/view/nomenclador/rh/PagoAdicional.js
 *
...
Ext.define('cerodatax.view.nomenclador.rh.PagoAdicional', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorrhpagoadicional',

    requires: [
        'cerodatax.view.nomenclador.ProvinciaViewModel8',
        'cerodatax.view.nomenclador.ProvinciaViewController8',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorrhpagoadicional',
    viewModel: {
        type: 'nomencladorrhpagoadicional'
    },
    ...
    items: [
        {
            ...
            title: '',
            forceFit: true,
            store: 'nomenclador.rh.PagoAdicional',
            columns: [
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'nombre',
