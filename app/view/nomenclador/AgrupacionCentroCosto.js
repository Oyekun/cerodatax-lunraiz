/*
 * File: app/view/nomenclador/AgrupacionCentroCosto.js
 *
...
Ext.define('cerodatax.view.nomenclador.AgrupacionCentroCosto', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladoragrupacioncentrocosto',

    requires: [
        'cerodatax.view.nomenclador.ClasificacionViewModel1',
        'cerodatax.view.nomenclador.ClasificacionViewController1',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladoragrupacioncentrocosto',
    viewModel: {
        type: 'nomencladoragrupacioncentrocosto'
    },
