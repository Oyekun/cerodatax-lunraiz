/*
 * File: app/view/nomenclador/ColorPielViewController.js
 *
...
Ext.define('cerodatax.view.nomenclador.ColorPielViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorcolorpiel',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.colorespiel');
        ...
        // Set title
        formPanel.setTitle('Adicionar Color de Piel');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Color de Piel');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Are you sure you want to delete this colorespiel?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('ColoresPiel');
