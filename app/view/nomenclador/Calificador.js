/*
 * File: app/view/nomenclador/Calificador.js
 *
...
Ext.define('cerodatax.view.nomenclador.Calificador', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorcalificador',

    requires: [
        'cerodatax.view.nomenclador.CalificadorViewModel',
        'cerodatax.view.nomenclador.CalificadorViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorcalificador',
    viewModel: {
        type: 'nomencladorcalificador'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Calificador</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorCalificador(config);
        if (instanceConfig) {
    ...
    processNomencladorCalificador: function(config) {
