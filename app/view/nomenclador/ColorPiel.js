/*
 * File: app/view/nomenclador/ColorPiel.js
 *
...
Ext.define('cerodatax.view.nomenclador.ColorPiel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorcolorpiel',

    requires: [
        'cerodatax.view.nomenclador.ColorPielViewModel',
        'cerodatax.view.nomenclador.ColorPielViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorcolorpiel',
    viewModel: {
        type: 'nomencladorcolorpiel'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Selecione el Color de Piel</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorColorPiel(config);
        if (instanceConfig) {
    ...
    processNomencladorColorPiel: function(config) {
