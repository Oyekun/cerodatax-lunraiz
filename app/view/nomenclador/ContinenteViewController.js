/*
 * File: app/view/nomenclador/ContinenteViewController.js
 *
...
Ext.define('cerodatax.view.nomenclador.ContinenteViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorcontinente',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.sexos');
        ...
        // Set title
        formPanel.setTitle('Adicionar Sexos');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Are you sure you want to delete this sexos?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Sexos');
