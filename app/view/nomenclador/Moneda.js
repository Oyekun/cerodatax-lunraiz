/*
 * File: app/view/nomenclador/Moneda.js
 *
...
Ext.define('cerodatax.view.nomenclador.Moneda', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladormoneda',
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione la Moneda</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorMoneda(config);
        if (instanceConfig) {
    ...
    processNomencladorMoneda: function(config) {
