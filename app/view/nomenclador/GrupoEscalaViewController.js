/*
 * File: app/view/nomenclador/GrupoEscalaViewController.js
 *
...
Ext.define('cerodatax.view.nomenclador.GrupoEscalaViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorgrupoescala',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.gruposescalas');
        ...
        // Set title
        formPanel.setTitle('Adicionar Grupo Escala');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Grupo Escala');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Are you sure you want to delete this gruposescalas?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('GruposEscalas');
