/*
 * File: app/view/nomenclador/CategoriaCientifica.js
 *
...
Ext.define('cerodatax.view.nomenclador.CategoriaCientifica', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorcategoriacientifica',

    requires: [
        'cerodatax.view.nomenclador.ClasificacionViewModel19',
        'cerodatax.view.nomenclador.ClasificacionViewController19',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorcategoriacientifica',
    viewModel: {
        type: 'nomencladorcategoriacientifica'
    },
