/*
 * File: app/view/nomenclador/TipoMenu.js
 *
...
Ext.define('cerodatax.view.nomenclador.TipoMenu', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladortipomenu',
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Tipo de Menu</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorTipoMenu(config);
        if (instanceConfig) {
    ...
    processNomencladorTipoMenu: function(config) {
