/*
 * File: app/view/nomenclador/CalificadorViewController2.js
 *
...
Ext.define('cerodatax.view.nomenclador.CalificadorViewController2', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorcuentabancaria',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.calificadores');
        ...
        // Set title
        formPanel.setTitle('Adicionar Calificador');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Calificador');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Are you sure you want to delete this calificadores?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Calificadores');
    ...
    save: function(button, e, eOpts) {
        var form = this.getReferences().form.getForm(),
            ...
            store = Ext.StoreManager.lookup('Usuarios');
