/*
 * File: app/view/nomenclador/CategoriaEntidadViewController.js
 *
...
Ext.define('cerodatax.view.nomenclador.CategoriaEntidadViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorcategoriaentidad',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.categoriaentidad');
        ...
        // Set title
        formPanel.setTitle('Adicionar Categoria');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Categoria');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Desea eliminar la Categoria?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('CategoriaEntidad');
