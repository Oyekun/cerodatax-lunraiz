...
Ext.define('cerodatax.view.nomenclador.Categoria', {
    ...
    requires: [
        'cerodatax.view.nomenclador.CategoriaViewModel',
        'cerodatax.view.nomenclador.CategoriaViewController',
        'Ext.grid.Panel',
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorCategoria(config);
        if (instanceConfig) {
    ...
    processNomencladorCategoria: function(config) {
