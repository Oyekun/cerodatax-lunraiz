/*
 * File: app/view/nomenclador/general/Idioma.js
 *
...
Ext.define('cerodatax.view.nomenclador.general.Idioma', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorgeneralidioma',

    requires: [
        'cerodatax.view.nomenclador.PaisViewModel2',
        'cerodatax.view.nomenclador.PaisViewController2',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorgeneralidioma',
    viewModel: {
        type: 'nomencladorgeneralidioma'
    },
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorPais(config);
        if (instanceConfig) {
    ...
    processNomencladorPais: function(config) {
