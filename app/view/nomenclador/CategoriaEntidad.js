/*
 * File: app/view/nomenclador/CategoriaEntidad.js
 *
...
Ext.define('cerodatax.view.nomenclador.CategoriaEntidad', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorcategoriaentidad',

    requires: [
        'cerodatax.view.nomenclador.CategoriaEntidadViewModel',
        'cerodatax.view.nomenclador.CategoriaEntidadViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorcategoriaentidad',
    viewModel: {
        type: 'nomencladorcategoriaentidad'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione la Categoria</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorCategoriaEntidad(config);
        if (instanceConfig) {
    ...
    processNomencladorCategoriaEntidad: function(config) {
