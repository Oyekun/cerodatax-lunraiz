/*
 * File: app/view/nomenclador/contabilidad/CuentaContable.js
 *
...
Ext.define('cerodatax.view.nomenclador.contabilidad.CuentaContable', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorcontabilidadcuentacontable',

    requires: [
        'cerodatax.view.nomenclador.BancoViewModel4',
        'cerodatax.view.nomenclador.BancoViewController4',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorcontabilidadcuentacontable',
    viewModel: {
        type: 'nomencladorcontabilidadcuentacontable'
    },
