/*
 * File: app/view/nomenclador/contabilidad/TipoCuenta.js
 *
...
Ext.define('cerodatax.view.nomenclador.contabilidad.TipoCuenta', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorcontabilidadtipocuenta',

    requires: [
        'cerodatax.view.nomenclador.ClasificacionViewModel17',
        'cerodatax.view.nomenclador.ClasificacionViewController17',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorcontabilidadtipocuenta',
    viewModel: {
        type: 'nomencladorcontabilidadtipocuenta'
    },
