/*
 * File: app/view/nomenclador/ClasificacionViewController12.js
 *
...
Ext.define('cerodatax.view.nomenclador.ClasificacionViewController12', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladortipoclasificacioncontable',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.clasificaciones');
        ...
        // Set title
        formPanel.setTitle('Adicionar Clasificaciones');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Clasificaciones');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Esta seguro que desea eliminar el elemento seleccionado?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Clasificaciones');
