/*
 * File: app/view/nomenclador/ProvinciaViewController2.js
 *
...
Ext.define('cerodatax.view.nomenclador.ProvinciaViewController2', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorcontabilidadclasificaciontipocuenta',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.provincias');
        ...
        // Set title
        formPanel.setTitle('Adicionar Provincias');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Provincias');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Esta seguro de eliminar el elemento seleccionado?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Provincias');
