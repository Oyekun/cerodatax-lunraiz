/*
 * File: app/view/nomenclador/TipoEntidad.js
 *
...
Ext.define('cerodatax.view.nomenclador.TipoEntidad', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladortipoentidad',
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Tipo Entidad</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorTipoEntidad(config);
        if (instanceConfig) {
    ...
    processNomencladorTipoEntidad: function(config) {
