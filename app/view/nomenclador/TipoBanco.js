/*
 * File: app/view/nomenclador/TipoBanco.js
 *
...
Ext.define('cerodatax.view.nomenclador.TipoBanco', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladortipobanco',

    requires: [
        'cerodatax.view.nomenclador.TipoBancoViewModel',
        'cerodatax.view.nomenclador.TipoBancoViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladortipobanco',
    viewModel: {
        type: 'nomencladortipobanco'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Tipo de Banco</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorTipoBanco(config);
        if (instanceConfig) {
    ...
    processNomencladorTipoBanco: function(config) {
