/*
 * File: app/view/nomenclador/MunicipioViewController.js
 *
...
Ext.define('cerodatax.view.nomenclador.MunicipioViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladormunicipio',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.municipios');
        ...
        // Set title
        formPanel.setTitle('Adicionar Municipios');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Municipios');
        ...
        Ext.Msg.confirm('Confirm Delete', 'Esta seguro que desea eliminar el elemento seleccionado?', function(result) {
            ...
            if (result == 'yes') {
                ...
                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Municipios');
