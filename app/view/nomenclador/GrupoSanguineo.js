/*
 * File: app/view/nomenclador/GrupoSanguineo.js
 *
...
Ext.define('cerodatax.view.nomenclador.GrupoSanguineo', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorgruposanguineo',

    requires: [
        'cerodatax.view.nomenclador.GrupoSanguineoViewModel',
        'cerodatax.view.nomenclador.GrupoSanguineoViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorgruposanguineo',
    viewModel: {
        type: 'nomencladorgruposanguineo'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Grupo Sanguineo</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorGrupoSanguineo(config);
        if (instanceConfig) {
    ...
    processNomencladorGrupoSanguineo: function(config) {
