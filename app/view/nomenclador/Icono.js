/*
 * File: app/view/nomenclador/Icono.js
 *
...
Ext.define('cerodatax.view.nomenclador.Icono', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladoricono',
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Icono</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorIcono(config);
        if (instanceConfig) {
    ...
    processNomencladorIcono: function(config) {
