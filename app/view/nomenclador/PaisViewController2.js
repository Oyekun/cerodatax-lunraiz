/*
 * File: app/view/nomenclador/PaisViewController2.js
 *
...
Ext.define('cerodatax.view.nomenclador.PaisViewController2', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorgeneralidioma',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.paises');
        ...
        // Set title
        formPanel.setTitle('Adicionar Paises');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Paises');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Esta seguro que desea eliminar el elemento?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Paises');
