/*
 * File: app/view/nomenclador/Sexo.js
 *
...
Ext.define('cerodatax.view.nomenclador.Sexo', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorsexo',

    requires: [
        'cerodatax.view.nomenclador.SexoViewModel',
        'cerodatax.view.nomenclador.SexoViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorsexo',
    viewModel: {
        type: 'nomencladorsexo'
    },
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorSexo(config);
        if (instanceConfig) {
    ...
    processNomencladorSexo: function(config) {
