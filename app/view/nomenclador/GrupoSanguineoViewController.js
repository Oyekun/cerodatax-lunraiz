/*
 * File: app/view/nomenclador/GrupoSanguineoViewController.js
 *
...
Ext.define('cerodatax.view.nomenclador.GrupoSanguineoViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladorgruposanguineo',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.grupossanguineos');
        ...
        // Set title
        formPanel.setTitle('Adicionar Grupo Sanguineo');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Grupo Sanguineo');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Are you sure you want to delete this grupossanguineos?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('GruposSanguineos');
