/*
 * File: app/view/nomenclador/Municipio.js
 *
...
Ext.define('cerodatax.view.nomenclador.Municipio', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladormunicipio',

    requires: [
        'cerodatax.view.nomenclador.MunicipioViewModel',
        'cerodatax.view.nomenclador.MunicipioViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladormunicipio',
    viewModel: {
        type: 'nomencladormunicipio'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Municipio</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorMunicipio(config);
        if (instanceConfig) {
    ...
    processNomencladorMunicipio: function(config) {
