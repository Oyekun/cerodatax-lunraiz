/*
 * File: app/view/nomenclador/DefensaViewController.js
 *
...
Ext.define('cerodatax.view.nomenclador.DefensaViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nomencladordefensa',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.defensa');
        ...
        // Set title
        formPanel.setTitle('Adicionar Defensa');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Editar Defensa');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Are you sure you want to delete this defensa?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = Ext.StoreManager.lookup('Defensas');
