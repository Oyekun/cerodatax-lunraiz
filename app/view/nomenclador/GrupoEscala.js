/*
 * File: app/view/nomenclador/GrupoEscala.js
 *
...
Ext.define('cerodatax.view.nomenclador.GrupoEscala', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nomencladorgrupoescala',

    requires: [
        'cerodatax.view.nomenclador.GrupoEscalaViewModel',
        'cerodatax.view.nomenclador.GrupoEscalaViewController',
        'Ext.grid.Panel',
    ...
    controller: 'nomencladorgrupoescala',
    viewModel: {
        type: 'nomencladorgrupoescala'
    },
                    ...
                    items: [
                        {
                            xtype: 'container',
                            flex: 1,
                            html: '<h1>Seleccione el Grupo Escala</h1>'
                        }
                    ]
                },
                {
    ...
    initConfig: function(instanceConfig) {
        var me = this,
            config = {};
        me.processNomencladorGrupoEscala(config);
        if (instanceConfig) {
    ...
    processNomencladorGrupoEscala: function(config) {
