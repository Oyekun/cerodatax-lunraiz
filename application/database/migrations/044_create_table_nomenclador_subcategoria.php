...
class Migration_create_table_nomenclador_subcategoria extends CI_Migration {
...
$this->dbforge->add_field('CONSTRAINT categoria_id FOREIGN KEY (categoria_id) REFERENCES nomenclador_categoria (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->dbforge->create_table('nomenclador_subcategoria');
               
    }

    public function down() {
        $this->dbforge->drop_table('nomenclador_subcategoria');
    }
