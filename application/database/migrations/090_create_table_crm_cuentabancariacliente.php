 ...
 *
 * @package     crm
 * @subpackage  CuentaBancariaCliente
 * @author      Leandro L. Céspedes Lara
 * @link        https://cerodatax.com
 */
defined('BASEPATH') OR exit('No direct script access allowed');

class Migration_create_table_crm_cuentabancariacliente extends CI_Migration {
...
$this->dbforge->add_field('CONSTRAINT cliente_id FOREIGN KEY (cliente_id) REFERENCES crm_cliente (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->dbforge->create_table('crm_cuentabancariacliente');
               
    }

    public function down() {
        $this->dbforge->drop_table('crm_cuentabancariacliente');
    }
