...
class Migration_create_table_persona_centrocostomovimientoempleado extends CI_Migration {
...
$this->dbforge->add_field('CONSTRAINT movimientoempleado_id FOREIGN KEY (movimientoempleado_id) REFERENCES persona_movimientoempleado (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->dbforge->create_table('persona_centrocostomovimientoempleado');
               
    }

    public function down() {
        $this->dbforge->drop_table('persona_centrocostomovimientoempleado');
    }
