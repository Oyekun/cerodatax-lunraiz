  ...
  //$cargos = [];
       ...
       $dataArray['created_from_ip'] = $dataArray['updated_from_ip'] = isset($_SERVER['REMOTE_ADDR']) ? $_SERVER['REMOTE_ADDR']: '127.0.0.1';
        ...
        $dataArray_cargo['nombre'] = $cargo;  
         $dataArray_cargo['date_created'] = $dataArray_cargo['date_updated'] = date('Y-m-d H:i:s');
         $dataArray_cargo['created_from_ip'] = $dataArray_cargo['updated_from_ip'] = isset($_SERVER['REMOTE_ADDR']) ? $_SERVER['REMOTE_ADDR']: '127.0.0.1';
