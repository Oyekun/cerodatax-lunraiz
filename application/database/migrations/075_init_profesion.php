...
class Migration_Init_profesion extends CI_Migration {
...
$string = read_file(APPPATH.'hooks/profesion.csv');
        ...
        if($existe==FALSE)
        {
            ...
            $model = 'nomenclador/rh/Profesion';
            $model1 = 'Profesion';
