...
*/
$config['tables']['users']           = 'seguridad_usuario';
$config['tables']['groups']          = 'seguridad_rol';
$config['tables']['users_groups']    = 'seguridad_rolusuario';
$config['tables']['login_attempts']  = 'seguridad_login_attempts';
 ...
 */
$config['site_title']                 = "cerodatax.com";       // Site Title, example.com
$config['admin_email']                = "lunraiz@cerodatax.com"; // Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 120;                   // The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
