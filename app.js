...
Ext.application({
    ...
    stores: [
        ...
        'nomenclador.rh.TipoPago',
        'nomenclador.rh.SalarioAdicional',
        'persona.AltaEmpleadoCentroCosto',
        'nomenclador.rh.OrganizacionPolitica',
        'persona.AltaEmpleadoOrganizacionPolitica',
        'nomenclador.general.Idioma',
        'persona.AltaEmpleadoIdioma',
